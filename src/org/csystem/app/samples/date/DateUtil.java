...
public class DateUtil {
	...
	public static String [] daysOfWeekTR = {"Pazar", "Pazartesi", "Salý", "Çarþamba", "Perþembe", "Cuma", "Cumartesi"};
	...
	public static void displayDateTR(int day, int month, int year)
	{
		...
		if (isWeekend(day, month, year))
			System.out.println("Bugün kurs var tekrar yaptýnýz mý?");
		else
			System.out.println("Hafta sonu kurs var. Tekrar yapmayý unutmayýnýz!!!");
	}
