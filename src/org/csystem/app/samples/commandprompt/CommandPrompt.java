...
public class CommandPrompt {
    ...
    private final ArrayList<String> m_textList = new ArrayList<String>();
    ...
    {
        if(commandInfo.length > 2){
            System.out.println("join en fazla 1 argüman alabilir");
            return;
        }
        ...
        if(m_textList.isEmpty()) {
         ...
         String str = StringUtil.join(m_textList,commandInfo.length == 2 ? commandInfo[1] : " ");
